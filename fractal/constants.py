"""Fractal Bitcoin network constants and configuration."""
...
class Network(str, Enum):
    """Supported Fractal Bitcoin networks."""
...
# API endpoints
API_ENDPOINTS: Final[dict[Network, str]] = {
    Network.MAINNET: "https://mempool.fractalbitcoin.io",
    Network.TESTNET: "https://mempool-testnet.fractalbitcoin.io",
}

# WebSocket endpoints  
WS_ENDPOINTS: Final[dict[Network, str]] = {
    Network.MAINNET: "wss://mempool.fractalbitcoin.io/api/v1/ws",
    Network.TESTNET: "wss://mempool-testnet.fractalbitcoin.io/api/v1/ws",
}

# Chain IDs
CHAIN_ID: Final[dict[Network, int]] = {
    Network.MAINNET: 0x2024,  # 8228 in decimal
    Network.TESTNET: 0x2025,  # 8229 in decimal
}

# Network magic numbers
MAGIC_NUMBERS: Final[dict[Network, bytes]] = {
    Network.MAINNET: bytes.fromhex("d99e94b9"),
    Network.TESTNET: bytes.fromhex("d99e94ba"),
}

# Block time in seconds (30 seconds for Fractal Bitcoin)
BLOCK_TIME: Final[int] = 30
...
USER_AGENT: Final[str] = "fractal-python/1.0.0"

# Address prefixes
ADDRESS_PREFIXES: Final[dict[str, dict[Network, bytes]]] = {
    "p2pkh": {
        Network.MAINNET: b"\x00",
        Network.TESTNET: b"\x6f",
    },
    "p2sh": {
        Network.MAINNET: b"\x05", 
        Network.TESTNET: b"\xc4",
    },
}

# Bech32 HRPs
BECH32_HRP: Final[dict[Network, str]] = {
    Network.MAINNET: "bc",
    Network.TESTNET: "tb",
}

# Transaction version
TX_VERSION: Final[int] = 2

# Dust limit in satoshis
DUST_LIMIT: Final[int] = 546

# Maximum block size
MAX_BLOCK_SIZE: Final[int] = 4_000_000

# Maximum script size
MAX_SCRIPT_SIZE: Final[int] = 10_000

# Satoshis per bitcoin
SATOSHIS_PER_BITCOIN: Final[int] = 100_000_000

# Maximum supply in satoshis (21M * 100M)
MAX_SUPPLY: Final[int] = 21_000_000 * SATOSHIS_PER_BITCOIN

# Константы для Taproot
